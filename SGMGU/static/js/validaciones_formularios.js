...
$(document).on('ready', function () {
    ...
    // validacion del formulario gestionar la demanda
    $('#registrar_demanda').bootstrapValidator({
        message: 'Este valor no es valido',
            ...
            anno_mas_uno: {
                validators: {
                    between: {
                        min: 0,
                        max: 5500000,
                        message: 'Debe introducir números enteros (Valor menor a 5 500 000)'
                    },
                    notEmpty: {
                        message: 'El valor del año es requerido'
                    }
                }
            },
            anno_mas_dos: {
    ...
    $('#registrar_existencia').bootstrapValidator({
        message: 'Este valor no es valido',
    ...
    $('#registrar_fluctuación').bootstrapValidator({
        message: 'Este valor no es valido',
