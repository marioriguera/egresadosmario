...
def menu(request):
    ...
    menu_dict={'menu':[
            ...
            {'name':'GeForza','url':reverse('geforza'),'icon':'glyphicon glyphicon-briefcase','visible':['administrador','especialista','organismo'],
               'menu':[
                    {'name':'Demanda','url':reverse('demandas'),'icon':'glyphicon glyphicon-chevron-right','visible':['administrador','especialista','organismo']},
                    {'name':'Existencia','url':reverse('existencias'),'icon':'glyphicon glyphicon-chevron-right','visible':['administrador','especialista','organismo']},
                    {'name':'Fluctuación','url':reverse('fluctuaciones'),'icon':'glyphicon glyphicon-chevron-right','visible':['administrador','especialista','organismo']},
            ...
            {'name':'Nomencladores','url':reverse('nomencladores'),'icon':'glyphicon glyphicon-bookmark','visible':['administrador','especialista'],
               'menu':[
                    ...
                    {'name':'Gestión de Tipo de Entidades', 'url': reverse('tiposentidades'),'icon': 'glyphicon glyphicon-chevron-right', 'visible': ['administrador', 'especialista']},
